...
const Hero = () => {
  return (
    <section className=' max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      />
      <h1 className=" bold-52 lg:bold-88">Makurdi Camp Area</h1>
      ...
      <p className="bold-16 lg:bold-20 text-blue-70">
        198k
        <span className="regular-16 lg:regular-20 ml-1 hover:underline cursor-pointer">Excellent Reviews</span>
      </p>
      </div>
      <div className=" flex flex-col w-full gap-3 sm:flex-row">
        <Button title="Download App"  type="button" variant="btn_green"/>
        <Button title="How we work?"  type="button" variant="btn_white_text" icon="/play.svg"/>
      </div>
      </div>
      ...
      <div className=" relative flex flex-1 items-start">
        <div className=" relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
         <div className="flex flex-col">
          ...
          <p className="bold-20 text-white">Wurukum</p>
          </div>
          <div className="flexBetween">
            <div className=" flex flex-col">
